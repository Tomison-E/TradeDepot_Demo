...
import 'package:tradedepot_demo/app/profile/presentation/logic/profileBloc/profile_cubit.dart';
import 'package:tradedepot_demo/app/profile/presentation/ui/screens/profile.dart';
    ...
    return Scaffold(
      appBar: AppBar(automaticallyImplyLeading: false,
        title: Row(children: [
          ...
          Text("TRADE DEPOT",style: TextStyle(color: Colours.navBarText,fontSize: 25,fontWeight: FontWeight.bold))
        ],),
      ...
      body:  PageView(
          ...
          children: <Widget>[
            Placeholder(),
            BlocProvider<ProfileCubit>(create: (context) => ProfileCubit(getIt: sl),
